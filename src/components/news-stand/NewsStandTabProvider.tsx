...
const NewsStandTabProvider = ({ children }: { children: React.ReactNode }) => {
...
export default NewsStandTabProvider;
...
export const useNewsStandTab = () => {
  ...
  if (!context) {
    throw new Error(
      'useNewsStandTab must be used within a NewsStandTabProvider',
    );
  }
  return context;
};
